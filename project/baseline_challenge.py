...
class BaselineChallenge(FlowSpec):
    ...
    def baseline(self):
        ...
        self.valdf[self._name]=1
        predictions = self.valdf[self._name]
        # TODO: return the accuracy_score of these predictions
        acc = accuracy_score(self.valdf['label'], self.valdf[self._name])

        # TODO: return the roc_auc_score of these predictions
        rocauc = roc_auc_score(self.valdf['label'], self.valdf[self._name])
